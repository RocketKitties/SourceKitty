...
<div class="content">
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				<h2><i class="fa fa-code"></i>Powerful Code Editor</h2>
				<p><%= application.name %> features a powerful code editor that supports syntax highlighting for most popular programming languages. </p>
			</div>
			<div class="col-sm-6">
				<div class="figure">
					<img src="images/info/features/code-editor.svg" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				...
				<p>Share your code in a variety of ways. </p>
				<ul>
