	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				...
				<p><%= application.name %> allows you to share your code in a variety of ways.  Create hyperlinks to files or folders for easy sharing with anyone or create shared files or folders to share with your <%= application.name %> connections. </p>
			</div>
			<div class="col-sm-6">
				<div class="icon-grid figure">
					<div class="file item">
					...
					<div class="file item">
						<div class="row">
							<div class="icon">
								<img src="images/icons/files/cpp.svg" />
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				...
				<p><%= application.name %> allows you to control access to your shared code. You can share as read-only or read-write.  When sharing items by hyperlink, you can also set a access limits, expiration time, date, and password. </p>
			</div>
			<div class="col-sm-6">
				<div class="figure">
