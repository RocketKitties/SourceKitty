...
<div class="content">
	<p><%= application.name %> is a cloud-based code storage, management, and sharing system. <%= application.name %> makes code sharing easy. Best of all, you can run it on your own server. </p>

	<div class="attention"><div class="emphasis">Your Code, <br />Your Cloud!</div></div>
	...
	<div class="details section">
		<div class="row">
			<div class="col-sm-6">
				...
				<ul>
					<li><b>Manage your code</b> - Organize your code into folders.</li>
					<li><b>Share your code</b> - Share code by link, shared folder, or email.</li>
			...
			<div class="col-sm-6">
				...
				<ul>
					<li>Keep your code <b>organized and accessible</b>. </li>
					<li>Easily <b>share</b> your code with friends, family, or colleagues. </li>
